...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xab, 0x0, 0xe5, 0x0, 0x0, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x6e, 0x0, 0xf5, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x5f, 0x0, 0xd8, 0x0,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 847, .adv_w = 320, .box_w = 18, .box_h = 18, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 1009, .adv_w = 320, .box_w = 20, .box_h = 18, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 1189, .adv_w = 320, .box_w = 18, .box_h = 18, .ofs_x = 1, .ofs_y = -3},
    {.bitmap_index = 1351, .adv_w = 320, .box_w = 19, .box_h = 19, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 1532, .adv_w = 320, .box_w = 21, .box_h = 17, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 1711, .adv_w = 320, .box_w = 20, .box_h = 17, .ofs_x = 0, .ofs_y = -3},
    {.bitmap_index = 1881, .adv_w = 320, .box_w = 20, .box_h = 12, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 2001, .adv_w = 320, .box_w = 12, .box_h = 18, .ofs_x = 4, .ofs_y = -3},
    {.bitmap_index = 2109, .adv_w = 320, .box_w = 18, .box_h = 18, .ofs_x = 1, .ofs_y = -3}
};
